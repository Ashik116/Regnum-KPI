...
import 'dashboard_admin_background.dart';
...
class _DashboardScreenAdminState extends State<DashboardScreenAdmin> {
  ...
  Widget build(BuildContext context) {
    ...
    return BackgroundAdminDashboard(
                          ...
                          Row(
                              ...
                              children: [
                                DashboardCard(
                                  ...
                                  label: 'Total Project',
                                  onPressed: () {},
                                  count: totalcount.toString(),//dashboardModel['totalProject'],
                                ),
                                DashboardCard(
                                  color: Colors.green.shade900,
                                  icon: Icons.insights,
                                  count: totalAdminTask.toString(),
                                  label: 'Total Admin Task',
                                  onPressed: () {},
                                ),
                              ]),
            ...
            userCollection.get().then((value) {
              if(value.size > 0){
                value.docs.forEach((element) async {
                  ...
                  sharedPreferences.setString('totalProject', totalProject.toString());
