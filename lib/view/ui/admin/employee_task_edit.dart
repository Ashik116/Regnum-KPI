...
class AdminEmployeeTaskEdit extends StatefulWidget {
  const AdminEmployeeTaskEdit({Key? key}) : super(key: key);

  @override
  _AdminEmployeeTaskEditState createState() => _AdminEmployeeTaskEditState();
}

class _AdminEmployeeTaskEditState extends State<AdminEmployeeTaskEdit> {
  String _projectType = "";
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((value) {
      ...
      isEmployeeTask = value.getBool('isEmployeeTask')!;
  ...
  void editTaskData(ExtraTaskModel extraTask) async {
    try {
      final CollectionReference extraTaskCollection = FirebaseFirestore.instance.collection('ExtraTaskInfo');
      await extraTaskCollection.doc(taskID).set({
        ...
        'employeeEmail': extraTask.employeeEmail,
